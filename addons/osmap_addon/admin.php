...
SpAddonsConfig::addonConfig(
    array(
        'type'=>'content',
        'addon_name'=>'osmap_addon',
        'title'=> JText::_('PLG_SPPAGEBUILDER_ADVANCED_OSMAPS_ADDON_TITLE'),
        'desc'=> JText::_('PLG_SPPAGEBUILDER_ADVANCED_MAPS_ADDON_DESC'),
        'icon'=>JURI::root() . 'plugins/sppagebuilder/advancedmaps/addons/assets/images/osmap.png',
